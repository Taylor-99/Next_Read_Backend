...
const userSchema = new mongoose.Schema({
    ...
    email : {type: String, required: true, unique: true}, //cannot create useres with the same email
    ...
    resetOtpExpireAt : {type: String, default: ''}, //Add the expire time or date for the reset OTP.
});
